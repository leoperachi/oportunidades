    ...
    <div class="card-body">
        ...
        <div id="registros">
            <form id="formConsultar" method="post" 
                action="<?php echo e(route('medicosClientes.consultar')); ?>">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="txtCRM"
                                    name="txtCRM"  value="<?php echo e($filtroObject->crmMedico); ?>">
                                <input id="txtIdMedicoCRM" type="hidden" 
                                    value="<?php echo e($filtroObject->idMedico); ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="txtMedico" id="txtMedico" class="form-control"
                                     autocomplete="off"  value="<?php echo e($filtroObject->nomeMedico); ?>">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input name="txtCliente" id="txtCliente" class="form-control"
                                     autocomplete="off" value="<?php echo e($filtroObject->nomeCliente); ?>">
                                ...
                                <div class="input-group" style="bottom: 10px;">
                                    <div class="input-group-append">
                                        ...
                                        <button  id="btnLimpar" name="acao" value="limpar"
                                            ...
                                            style="width:50px" url="<?php echo e(route('medicosClientes.pesquisa')); ?>">
                                        </button>
                                        <button type="button" id="btnConsultar" 
                                            url="<?php echo e(route('medicosClientes.consultar')); ?>"
                                        ...
                                        <a href="javascript:navigate('<?php echo e(route('medicosClientes.inserir')); ?>');" 
                ...
                <table id="myTable" class="display table table-striped" >
                    ...
                    <tbody>
                        <?php $__currentLoopData = $medicoCLientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="dados">   
                                <td style="width: 3px;" class="dt-body-center">
                                    <input type="checkbox"  name="chkOportunidade[]"  
                                        class="chkSelect" value="<?php echo e($mc->id); ?>">
                                </td>
                                <td class="clickable" style="max-width:50px" data-id="<?php echo e($mc->id); ?>">
                                    <?php echo e($mc->crmMedico); ?>

                                </td>
                                <td class="clickable" data-id="<?php echo e($mc->id); ?>">
                                    <?php echo e($mc->nomeMedico); ?>

                                </td>
                                <td class="clickable" data-id="<?php echo e($mc->id); ?>">
                                    <?php echo e($mc->clienteNome); ?>
...
<?php /**PATH E:\Backup HD Toshiba\Projetos\juliano\docservice\resources\views/medicosClientes/listar.blade.php ENDPATH**/ ?>