...
<div class="card" id="app">
    <div class="card-body">
        ...
        <div id="registros">
            <form method="POST" action="<?php echo e(route('convenio.cadastrar')); ?>">
                <?php echo csrf_field(); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="descricao" class="form-control form-control-md  <?php if ($errors->has('descricao')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('descricao'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" value="<?php echo e(old('descricao')); ?>">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Backup HD Toshiba\Projetos\juliano\docservice\resources\views/doctorservice/convenio/cadastro.blade.php ENDPATH**/ ?>